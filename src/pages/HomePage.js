        ...
        <div>
            <div>
                <main className="flex-shrink-0 ">
                    <Navbar />
                    <header className="mb-5 header2">
                        <div className="container px-5 pb-5">
                            <div className="row gx-5 align-items-center">
                                <div className="col-xxl-5">
                                    {/* Header text content*/}
                                    <div className="text-center text-xxl-start">
                                        <p className="fs-3 fw-light text-muted" data-aos="fade-down">I am software engineer and i can help your business to</p>
                                        <h1 className="display-3 fw-bolder mb-5" data-aos="fade-down"><span className="text-gradient d-inline" >Get online and grow fast</span></h1>
                                        <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                            <NavLink className="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" to="/Resume" data-aos="fade-right">Resume</NavLink>
                                            <NavLink className="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" to="/Projects" data-aos="zoom-in-left">Projects</NavLink>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xxl-7 ">
                                    {/* Header profile picture*/}
                                    <div className="d-flex justify-content-center mt-0 mt-xxl-0 mb-5">
                                        <div className="profile  mb-5 " data-aos="fade-down" >
                                            {/* TIP: For best results, use a photo with a transparent background like the demo example below*/}
                                            {/* Watch a tutorial on how to do this on YouTube (link)*/}
                                            <img className="profile-img h-100  mb-5 " src="/assets/profile.png" alt="..." width={300} height={500} />
                                ...
                                <div className="col-xxl-8">
                                    <div className="text-center my-5">
                                        ...
                                        <div className="d-flex justify-content-center fs-2 gap-4" data-aos="zoom-in-up">
                                            ...
                                            <a className="text-gradient" href="https://github.com/Sele41" target='https://github.com/Sele41'><i className="bi bi-github" /></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
